...
class _AnimatedCountdownState extends State<AnimatedCountdown>
  ...
  Color _getCountdownColor(int count) {
    if (count <= 1) return const Color(0xFFFF3366); // Energetic Crimson
    if (count <= 2) return const Color(0xFFFF9900); // Vibrant Amber
    if (count <= 3) return const Color(0xFFFFD700); // Gold
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          // Subtitle with animated breathing and glowing badge
          Container(
